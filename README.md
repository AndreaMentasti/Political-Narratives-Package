...
**What is a Political Narrative?** According to [Gehring & Grigoletto (2025)](https://www.econstor.eu/handle/10419/327674), a *political narrative* is defined by three elements: *(i) a topic, (ii) a set of characters, and (iii) at least one character cast in a drama triangle role: hero, villain, or victim*. These roles, rooted in classic storytelling traditions, provide a simple yet powerful structure that has shaped narratives since the earliest written accounts. Political narratives act as interpretive tools: they simplify complexity, assign meaning, and guide perception. By casting characters into familiar archetypes, they help audiences make sense of political issues and events, shaping beliefs, attitudes, and preferences in the process.

More formally, to define a *political narrative*, choose a topic *T* and a universe of characters *K = H ∪ I*, where H and I represent Human and Instrument characters. For any text unit (tweet, paragraph, article), let *K′ ⊆ K* be the set of characters that appear.  
