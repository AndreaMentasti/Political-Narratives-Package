...
csv_path = os.path.join(main, "data", "output", "your_data_stage2.csv") 
path_df = os.path.join(main, "data", "output", "your_data_stage2.feather")

prompt_path = os.path.join(main, "code", "prompts", "system_message_stage2.json") # This to be uploaded
