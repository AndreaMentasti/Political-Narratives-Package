...
prompt_path = os.path.join(main, "code", "prompts", "zero_sum_prompt.json") # This to be uploaded
...
def build_user_content(article_group):
    ...
    user_content = (
        ...
        "Each object MUST include keys: id, a (a in {1,2,3,4}). "
            ...
            try:
                ...
                for entry in json_list:
                    ...
                    flattened_entry = {
                        ...
                        "id": entry_id,
                        # default to 4 (No Classification) if missing
                        "a": entry.get("a", 4)
                    }
